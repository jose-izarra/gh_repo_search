...
/*
    This is the hero section of the user's profile page.
    It displays the user's avatar, name, login, bio, followers, following, and public repositories.
*/
...
export default function Hero({
    ...
    // If data is still being fetched, show a fallback state
    if (isLoading) {
        return (
